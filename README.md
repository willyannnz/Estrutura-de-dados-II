...
Atividade_2/                 -> Arquivos referentes à Atividade 2 (arrays,
                               matrizes, ordenação e busca)
...
Atividade_3/                 -> Arquivos referentes à Atividade 3 (central
...
Cada atividade fica na sua própria pasta (`Atividade_2/`, `Atividade_3/`), e dentro dela cada parte/experimento também tem sua própria subpasta ou arquivo — isso facilita achar e avaliar cada critério separadamente.
...
```bash
python "Atividade_2/Parte2_Ordenacao/parte2.py"
python "Atividade_2/Parte3_BuscaMatriz/parte3.py"
python "Atividade_2/Parte4_HandsOn1/parte4.py"
python "Atividade_2/Parte5_HandsOn2/parte5.py"
python "Atividade_3/experimento_ordenacao.py"
python "Atividade_3/desafio_adicional.py"
```
